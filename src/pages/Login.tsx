...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 bg-gray-900">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-display font-bold text-white">Remindly</h1>
            <p className="text-primary-300 font-medium mb-2">BY MSR</p>
